...
AddOutputFilter chunkFilter
		...
		<Item Name="SubVIs" Type="Folder">
			...
			<Item Name="Encoders.vi" Type="VI" URL="../SubVIs/Encoders.vi"/>
			<Item Name="Motor.vi" Type="VI" URL="../SubVIs/Motor.vi"/>
			<Item Name="PI Control Anti Windup.vi" Type="VI" URL="../SubVIs/PI Control Anti Windup.vi"/>
			<Item Name="PID_Control.vi" Type="VI" URL="../SubVIs/PID_Control.vi"/>
		</Item>
		<Item Name="Quick Start.vi" Type="VI" URL="../SubVIs/Quick Start.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
